              ...
              <v-card>
                <v-card-text>
                  ...
                  <v-flex v-if="requirement.typeform" xs12>
                    <v-flex xs12 v-for="(answer, index) in typeformAnswers"
                  ...
                  <v-flex v-else xs12 class="mb-3">
                    Since the
                    <span style="font-weight: bold">{{ requirement.createdAt |
                      formatDate('LLL') }}</span>
                    ...
                    <span style="font-weight: bold">{{
                      requirement.seniority.l10nKey }}</span>
                    <span style="font-weight: bold">{{
                      requirement.jobType.l10nKey }}</span>
                    based in
                    <span style="font-weight: bold">{{ requirement.location }}</span>
                    for a max fixed salary of
                    <span style="font-weight: bold">{{ requirement.fixedSalary
                      }} €</span>
                  </v-flex>
                  <v-flex xs12>
                    <h3 class="text-xs-center">Sent opportunities : {{
                ...
                <v-tabs grow>
                  ...
                  <v-tab-item>
                    <v-card-text>
                      ...
                      <v-textarea label="Notes" v-model="requirement.notes"
                        prepend-inner-icon="lock" rows="27"></v-textarea>
